...
curl -X POST http://localhost:8000/reset-all-counters -H "Content-Type: application/json" -d "{\"resetDailyProgress\":true,\"resetCallLogs\":false,\"resetNumberClaims\":true,\"resetAssignmentCounters\":true}"
